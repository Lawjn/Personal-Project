...
{
    /// <inheritdoc />
    public partial class AddInventoryAndSalesModels : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ConfidenceLevel = table.Column<decimal>(type: "decimal(5,2)", precision: 5, scale: 2, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Forecasts_VehicleModels_VehicleModelId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SellFromInventories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SellFromInventories_Inventories_InventoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Forecasts_VehicleModelId",
                table: "Forecasts",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SellFromInventories_InventoryId",
                table: "SellFromInventories",
                column: "InventoryId");
